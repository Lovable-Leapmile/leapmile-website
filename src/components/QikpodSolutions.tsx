...
const SolutionCard = ({ title, image, caption, buttonText, pageName }: SolutionCardProps) => {
  ...
  return (
    <Card className="h-full flex flex-col text-center bg-qikpod-white border-gray-200 hover:shadow-lg transition-shadow">
      ...
      <CardContent className="flex-1 flex flex-col">
        ...
        <Button 
          ...
          className="bg-qikpod-yellow hover:bg-qikpod-yellow/90 text-qikpod-black"
        >
          {buttonText}
