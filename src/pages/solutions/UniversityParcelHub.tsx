...
import { Calendar, Package, Bell, User, GraduationCap, Wrench, BarChart3 } from "lucide-react";
import q35 from "@/assets/q35.png";
import Footer from "@/components/Footer";
import QikpodFooter from "@/components/QikpodFooter";

const UniversityParcelHub = () => {
  ...
  const solutions = [
    ...
    { name: "University Parcel Hub", path: "/qikpod/solutions/university-parcel-hub", active: true },
  ...
  const benefits = [
    {
      icon: <GraduationCap className="h-12 w-12 text-qikpod-yellow" />,
      title: "For Students & Staff",
      description: "Safe & private, no courier calls, enhanced campus experience"
    },
    {
      icon: <Wrench className="h-12 w-12 text-qikpod-yellow" />,
      title: "Preventive Maintenance",
      description: "Proactive monitoring and maintenance for optimal performance"
    },
    {
      icon: <BarChart3 className="h-12 w-12 text-qikpod-yellow" />,
      title: "Usage & Billing Reports",
      description: "Comprehensive analytics and reporting for campus administrators"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-qikpod-white">
      ...
      <section 
        ...
        style={{
          backgroundImage: "linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url('https://leapmile-website.blr1.cdn.digitaloceanspaces.com/Qikpod/Images/q75.png')",
      ...
      >
        <div className="container mx-auto px-6 md:px-12 text-center text-white pt-20">
          <h1 className="text-3xl md:text-5xl font-bold mb-6 text-qikpod-yellow">
            Automated Management of parcels designed for large University Campuses
          </h1>
          <h3 className="text-xl md:text-2xl mb-8 max-w-4xl mx-auto">
            Our robots enable self-service pickup in stores and in close proximity locations.
          </h3>
          <Button 
        ...
        <div className="container mx-auto px-6 md:px-12">
          <div className="text-center mb-12">
            ...
            <h3 className="text-xl font-semibold text-qikpod-black">
              Improve the experience of campus-wide delivery.
            </h3>
          </div>
            ...
            <div className="order-1 lg:order-2">
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <span className="text-qikpod-black">Industry-first smart parcel management platform designed to scale with campus growth</span>
                </li>
                <li className="flex items-start">
                  <div className="w-2 h-2 bg-qikpod-yellow rounded-full mt-2 mr-3 flex-shrink-0"></div>
                ...
                <li className="flex items-start">
                  <div className="w-2 h-2 bg-qikpod-yellow rounded-full mt-2 mr-3 flex-shrink-0"></div>
                  <span className="text-qikpod-black">Optimized storage, designed to install across university campuses</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="container mx-auto px-6 md:px-12">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-qikpod-black/80 max-w-2xl mx-auto mb-8">
              Provide a secure, campus-wide pickup experience with QikPod Parcel Management Solutions.
            </p>
          </div>
...
export default UniversityParcelHub;