...
const UniversityParcelHub = () => {
  ...
  const solutions = [
    ...
    { name: "University Parcel Hub", path: "/solutions/university-parcel-hub", active: true },
            ...
            <div className="order-1 lg:order-2">
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <span className="text-foreground">Industry-first smart parcel management platform designed to scale with campus growth</span>
                </li>
                <li className="flex items-start">
                  <div className="w-2 h-2 bg-primary rounded-full mt-2 mr-3 flex-shrink-0"></div>
                ...
                <li className="flex items-start">
                  <div className="w-2 h-2 bg-primary rounded-full mt-2 mr-3 flex-shrink-0"></div>
                  <span className="text-foreground">Optimized storage, designed to install across university campuses</span>
                </li>
              </ul>
            </div>
          </div>
