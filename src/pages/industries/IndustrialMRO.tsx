        ...
        <div className="page-wrapper">
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              {/* Left Content */}
              <div>
                <Badge variant="outline" className="mb-4">Industrial & MRO</Badge>
                <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
                  Revolutionizing Industrial & MRO Fulfillment
                </h1>
                <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                  Introducing NanoWarehouse: Revolutionizing industrial fulfillment and MRO in manufacturing. 
                  Our platform ensures precise and swift parts delivery, promoting lean manufacturing and efficiency. 
                  NanoWarehouse accelerates order fulfillment, reduces costs, and enhances customer satisfaction, 
                  making it ideal for industries seeking process optimization, even in small spaces (as small as 1000 sq ft). 
                  With NanoWarehouse, experience lower capital investment, reduced risk, and increased profitability.
                </p>
                ...
                <div className="space-y-3 mb-8">
                  <div className="flex items-center">
                    ...
                    <span className="text-foreground">Quadruples picking productivity</span>
                  </div>
                  <div className="flex items-center">
                    <div className="w-2 h-2 bg-primary rounded-full mr-3"></div>
                    <span className="text-foreground">System payback in &lt;3 years</span>
                  </div>
                  <div className="flex items-center">
                    <div className="w-2 h-2 bg-primary rounded-full mr-3"></div>
                    <span className="text-foreground">Efficiently accommodates storage of 1,000+ SKUs</span>
                  </div>
                </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground">
                Experience unmatched efficiency with our industrial solutions
              </p>
            </div>
