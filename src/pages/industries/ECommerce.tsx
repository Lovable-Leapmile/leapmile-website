        ...
        <div className="container mx-auto px-4 lg:px-6 xl:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              {/* Left Content */}
              <div>
                <Badge variant="outline" className="mb-4">E-Commerce</Badge>
                <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
                  Empowering E-Commerce
                </h1>
                <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                  In the face of increasing consumer diversity and individualization, e-commerce companies are 
                  confronted with the challenge of meeting elevated expectations for user experiences and delivery services. 
                  These expectations encompass faster order fulfillment, a broader variety of products (SKUs), 
                  heightened order volume, and an increase in returns.
                </p>
                ...
                <div className="space-y-3 mb-8">
                  <div className="flex items-center">
                    ...
                    <span className="text-foreground">Effortless item picking</span>
                  </div>
                  <div className="flex items-center">
                    <div className="w-2 h-2 bg-primary rounded-full mr-3"></div>
                    <span className="text-foreground">Seamless restocking operations</span>
                  </div>
                </div>
              ...
              <div className="relative">
                <div className="aspect-square rounded-2xl overflow-hidden">
                  <img src="https://leapmile-website.blr1.cdn.digitaloceanspaces.com/Technology/Images/omnichannelheader.png" alt="E-Commerce warehouse automation" className="w-full h-full object-contain" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground">
                Experience unmatched efficiency with our e-commerce solutions
              </p>
            </div>
